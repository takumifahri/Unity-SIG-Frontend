            ...
            <Box sx={{ marginBottom: 4 }}>
              ...
              >
                ...
                >
                  <Box
                    component="img"
                    src={`${process.env.REACT_APP_API_URL}/${orderDetail.custom_order?.gambar_referensi || 'placeholder.jpg'}`}
                    alt="Reference Image"
                    sx={{
                      width: "100%",
                      maxHeight: "550px",
                    ...
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>{orderDetail.custom_order?.jenis_baju || "-"}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell sx={{ fontWeight: 500 }}>Bahan</TableCell>
                          <TableCell>{orderDetail.custom_order?.bahan?.nama_bahan || "-"}</TableCell>
                        </TableRow>
                        <TableRow>
            ...
            <Box sx={{ marginBottom: 4 }}>
              {orderDetail.custom_order ? (
                ...
                >
                  ...
                  >
                    <Typography variant="h5" sx={{ fontWeight: 600, color: "#75584A", mb: 2 }}>
                      {orderDetail.custom_order.jenis_baju || "Pesanan Kustom"}
                    </Typography>
                    
                    <Typography variant="body1" sx={{ mb: 2 }}>
                      {orderDetail.custom_order.deskripsi || "Tidak ada deskripsi tambahan"}
                    </Typography>
                    ...
                    >
                      <Table>
                        ...
                        <TableBody>
                          ...
                          <TableRow>
                            <TableCell sx={{ fontWeight: 500 }}>Deskripsi Bahan</TableCell>
                            <TableCell>{orderDetail.custom_order.bahan?.deskripsi || "-"}</TableCell>
                          </TableRow>
                          <TableRow>
                            <TableCell sx={{ fontWeight: 500 }}>Warna</TableCell>
                            <TableCell>{orderDetail.color || "-"}</TableCell>
                ...
                <Typography variant="body1" sx={{ textAlign: "center", py: 3 }}>
                  Data pesanan kustom tidak tersedia
                </Typography>
              )}
            </Box>
          )}
