...
export default function Register() {
  ...
  // Handle closing the snackbar - memoized to prevent unnecessary re-renders
  ...
  const handleChange = useCallback((e) => {
    ...
    setErrors(prev => name in prev ? {
      ...prev,
      [name]: null,
    } : prev);
  }, []);

  // Form validation logic - memoized to prevent recreation on every render
  ...
  const openTermsDialog = useCallback((e) => {
    e.preventDefault();
    setShowTerms(true);
  }, []);
  ...
  // Register API call - extracted for better organization
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      ...
      {/* Terms and Conditions Dialog - Using memoized dialog */}
      {termsDialog}
