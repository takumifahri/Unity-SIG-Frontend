      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold">Detail Pesanan #{selectedOrder.id.toString().padStart(5, '0')}</h2>
            <button
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p><span className="font-medium">Produk:</span> {selectedOrder.produk}</p>
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Pesanan Catalog</h1>
