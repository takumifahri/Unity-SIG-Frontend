    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p className="text-sm text-gray-600 mt-2">
          Tidak punya akun? <a href="/register" className="text-indigo-600 hover:underline">Daftar segera!</a>
        </p>
        </div>

        <button
        type="submit"
        className="w-full bg-[#6D4C3D] text-white py-2 px-4 rounded-md hover:bg-[#6B4838] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        disabled={loading}
        >
        ...
        <button
        type="button"
        className="w-full flex items-center justify-center gap-2 border border-gray-300 py-2 px-4 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
