...
const TabelBahan = () => {
  ...
  const { bahanList, deleteBahan, setEditingBahan } = useBahan();
  ...
  const handleEdit = (bahan) => {
    ...
    navigate('/bahan/tambah');
  };

  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6">Tabel Bahan</h2>
      ...
      <div className="flex justify-between items-center mt-4">
        <div>
          Showing 1 to {Math.min(entriesPerPage, bahanList.length)} of {bahanList.length} entries
        </div>
        <div className="flex space-x-2">
